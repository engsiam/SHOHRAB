      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-12 mb-12">
          ...
          <div className="flex gap-8 items-center">
            <a className="text-slate-500 hover:text-white transition-colors" href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer">
              <Github className="w-6 h-6" />
            </a>
            <a className="text-slate-500 hover:text-white transition-colors" href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 gap-6">
          <div className="text-[10px] tracking-widest uppercase font-bold text-slate-500">© 2024 MD. SHOHRAB HOSSAIN. ALL RIGHTS RESERVED.</div>
